...
class Router
{
    ...
    /**
     * On vient instancier chaque middleware de notre route et on appelle leurs méthodes handle() les unes à la suite des autres
     */
    protected function middlewares(Route $route): void
    {
        foreach ($route->getMiddlewares() as $middleware) {
            // On instancie le middleware entre parenthèses ET on appelle directement la méthode handle() (évite de le faire en 2 lignes)
